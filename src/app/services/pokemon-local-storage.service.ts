...
// /**
//  * Implémentation du service Pokémon utilisant le localStorage du navigateur
//  *
//  * Cette classe implémente l'interface PokemonService et stocke les données
//  * directement dans le localStorage du navigateur (pas de backend).
//  *
//  * Avantages :
...
//  *
//  * Limitations :
//  * - Données locales à chaque navigateur
//  * - Limite de stockage (~5-10 MB selon le navigateur)
//  * - Pas de synchronisation multi-utilisateurs
//  *
//  * Utilisé pour les démos et prototypes rapides.
//  */
// export class PokemonLocalStorageService implements PokemonService {
//   // Clé utilisée pour stocker/récupérer les données dans localStorage
//   private localStorageKey = 'pokemons';

//   /**
//    * Initialise les données dans le localStorage si elles n'existent pas encore
//    *
//    * Crée une collection de Pokémons par défaut au premier chargement.
//    * Si des données existent déjà, cette méthode ne fait rien.
//    *
//    * Cette méthode est appelée à chaque chargement de la page pour
//    * garantir qu'il y a toujours des données disponibles.
//    */
